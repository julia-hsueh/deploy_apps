...
def run_eda_app():
	...
	df = load_data("./exam/week04_薛婕/diabetes_prediction_ml_app/data/diabetes_data_upload.csv")
	df_clean = load_data("./exam/week04_薛婕/diabetes_prediction_ml_app/data/diabetes_data_upload_clean.csv")
	freq_df = load_data("./exam/week04_薛婕/diabetes_prediction_ml_app/data/freqdist_of_age_data.csv")
